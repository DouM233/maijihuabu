...
function UpscaleNode(props: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border">
        <div className="w-6 h-6 rounded-md bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 flex items-center justify-center">
          <ZoomIn className="w-3.5 h-3.5" />
        </div>
        <span className="text-sm font-medium text-foreground">超分</span>
      </div>
      ...
      <div className="p-3">
        {outputUrl ? (
          <div className="rounded-lg overflow-hidden border border-border">
            <img src={outputUrl} alt="upscaled" className="w-full h-32 object-cover" />
          </div>
        ) : (
